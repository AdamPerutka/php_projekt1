...
$googleClientID = '893860751361-a3rmlquu2hvpiaor0naarsca7reqru0u.apps.googleusercontent.com';
$googleClientSecret = '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';
...
if(!isset($_GET['action'])) {
  if(!empty($_SESSION['user_id'])) {
    ...
    echo '<h3>Prosim, prihlás sa pomocou google konta</h3>';
